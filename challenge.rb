code = "epqiiqwdiwgyka_vsqtsujeqqicnhyivo_sigwasmkwgsih_akl_gtnkhgikgveidpmt
...
mnshz_xz
"
secretLetters = code.chars.to_a
letterCount = Hash.new 0
completedCode = ""

secretLetters.each do |count|
    letterCount[count] += 1
end

letterCount = letterCount.sort_by{|k,v| v}.reverse.to_h

#used loop to visually see letter and letter count outputted.
#letterCount.each do |key, value|
 #   puts "#{key} : #{value}"
#end

letterCount.each do |k,v|
    if k != "_"
        completedCode << k
    end
